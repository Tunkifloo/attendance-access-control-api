...
public class FirebaseEventListener {
    ...
    private void listenToAttendance() {
        ...
        log.info("Attendance listener registered on logs/asistencia");
    }
    ...
    private void processAttendanceEvent(DataSnapshot snapshot) {
        try {
            ...
            if (matcher.find()) {
                ...
                log.info("Attendance processed successfully for RFID: {}", rfidUid);
            } else {
    ...
    private void listenToAccessLogs() {
        ...
        log.info("Access listener registered on logs/accesos");
    }
